  ...
  const fetchAllContacts = useCallback(async () => {
    ...
    try {
      do {
        ...
        fetchedContacts = response.documents.map((doc) => ({
          id: doc.$id,
          name: doc.name,
          email: doc.email,
        ...
        allContacts = [...allContacts, ...fetchedContacts];
        offset += limit;
      } while (fetchedContacts.length === limit); // Continue fetching if the limit was reached
